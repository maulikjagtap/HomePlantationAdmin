...
public class UpdataHybridplantdata extends AppCompatActivity implements View.OnClickListener {
    private String key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updata_hybridplantdata);
        ...
        indoor_img=findViewById(R.id.updatehybrid_image);
        choose_image=findViewById(R.id.updatehybrid_Imagebutton_chooseimage);
        indoor_name=findViewById(R.id.updatehybrid_name_edittext);
        indoor_decription=findViewById(R.id.updatehybriddecription_edittext);
        indoor_price=findViewById(R.id.updatehybrid_price_edittext);
        updateiteam=findViewById(R.id.updatehybrid_button);
        updateiteam.setOnClickListener(this);
        choose_image.setOnClickListener(this);
        databaseReference.child("HybridPlant").child(firebaseAuth.getCurrentUser().getUid())
                .child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String data_dec=dataSnapshot.child("hybrid_decription:").getValue().toString();
                String data_name=dataSnapshot.child("hybrid_name").getValue().toString();
                String data_price=dataSnapshot.child("hybrid_price").getValue().toString();
                String data_image=dataSnapshot.child("hybrid_url").getValue().toString();
                ...
                Glide.with(UpdataHybridplantdata.this).load(data_image).into(indoor_img);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case  R.id.updatehybrid_Imagebutton_chooseimage:
                ChooseImage();
                break;
            case R.id.updatehybrid_button:
                updatehybridplant();
                break;

        }
    }
    private void updatehybridplant() {
        ...
        databaseReference.child("Admin_User").child(firebaseAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                HybridModel hybridModel= new HybridModel(indoorname,description,myuri,nurrsery,indoorprice);
                databaseReference.child("HybridPlant").child(firebaseAuth.getCurrentUser().getUid()).push().setValue(hybridModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(UpdataHybridplantdata.this, "done", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void uploadImage() {
        ...
        reference.putFile(selectimge).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(UpdataHybridplantdata.this, "yes", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(Userpicandotherdata.this, ""+path, Toast.LENGTH_SHORT).show();
                ...
                storageRef.child(path).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        myuri= uri.toString();
                        Toast.makeText(UpdataHybridplantdata.this, ""+myuri, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UpdataHybridplantdata.this, "no", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
