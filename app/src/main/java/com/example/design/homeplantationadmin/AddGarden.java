...
public class AddGarden extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flower_img=findViewById(R.id.addgarden_image);
        choose_image=findViewById(R.id.addgarden_Imagebutton_chooseimage);
        flower_decription=findViewById(R.id.addgarden_decription_edittext);

        additeam=findViewById(R.id.addgarden_button);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.addgarden_Imagebutton_chooseimage:
                ChooseImage();
                break;
            case R.id.addgarden_button:
                addgarden();
                break;
    ...
    private void addgarden() {
        ...
        GardenModel gardenModel=new GardenModel(description,myuri);
        databaseReference.child("GadenDesign").push().setValue(gardenModel).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(AddGarden.this, "done", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(AddGarden.this,AddData.class));
                finish();
            }
        });
    ...
    private void uploadImage() {
        ...
        reference.putFile(selectimge).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddGarden.this, "yes", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(Userpicandotherdata.this, ""+path, Toast.LENGTH_SHORT).show();
                ...
                storageRef.child(path).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        myuri= uri.toString();
                        Toast.makeText(AddGarden.this, ""+myuri, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AddGarden.this, "no", Toast.LENGTH_SHORT).show();
            }
        });
    }
