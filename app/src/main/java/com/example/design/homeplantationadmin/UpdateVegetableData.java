...
public class UpdateVegetableData extends AppCompatActivity implements View.OnClickListener {
    private String key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_vegetable_data);
        ...
        outdoor_img=findViewById(R.id.updatevege_image);
        choose_image=findViewById(R.id.updatevege_Imagebutton_chooseimage);
        outdoor_name=findViewById(R.id.updatevege_name_edittext);
        outdoor_decription=findViewById(R.id.updatevegedecription_edittext);
        outdoor_price=findViewById(R.id.updatevege_price_edittext);
        updateiteam=findViewById(R.id.updatevege_button);
        updateiteam.setOnClickListener(this);
        choose_image.setOnClickListener(this);
        databaseReference.child("VegetablePlant").child(firebaseAuth.getCurrentUser().getUid())
                .child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String data_dec=dataSnapshot.child("vegetable_decription").getValue().toString();
                String data_name=dataSnapshot.child("vegetable_name").getValue().toString();
                String data_price=dataSnapshot.child("vegetable_price").getValue().toString();
                String data_image=dataSnapshot.child("vegetable_url").getValue().toString();
                ...
                Glide.with(UpdateVegetableData.this).load(data_image).into(outdoor_img);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.updatevege_Imagebutton_chooseimage:
                ChooseImage();
                break;
            case R.id.updatevege_button:
                UpadateOutdoorData();
                break;
        }
    ...
    private void UpadateOutdoorData() {
        ...
        databaseReference.child("Admin_User").child(firebaseAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                VegetableModel vegetableModel= new VegetableModel(outdoorname,description,myuri,nurrsery,outdoorprice);
                databaseReference.child("VegetablePlant").child(firebaseAuth.getCurrentUser().getUid()).push().setValue(vegetableModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(UpdateVegetableData.this, "done", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void uploadImage() {
        ...
        reference.putFile(selectimge).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(UpdateVegetableData.this, "yes", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(Userpicandotherdata.this, ""+path, Toast.LENGTH_SHORT).show();
                ...
                storageRef.child(path).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        myuri= uri.toString();
                        Toast.makeText(UpdateVegetableData.this, ""+myuri, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UpdateVegetableData.this, "no", Toast.LENGTH_SHORT).show();
            }
        });
    }
