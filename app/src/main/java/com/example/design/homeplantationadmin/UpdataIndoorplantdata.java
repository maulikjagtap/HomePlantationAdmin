...
public class UpdataIndoorplantdata extends AppCompatActivity implements View.OnClickListener {
    private String key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updata_indoorplantdata);
        ...
        indoor_img=findViewById(R.id.updateindoor_image);
        choose_image=findViewById(R.id.updateindoor_Imagebutton_chooseimage);
        indoor_name=findViewById(R.id.updateindoor_name_edittext);
        indoor_decription=findViewById(R.id.updateindoordecription_edittext);
        indoor_price=findViewById(R.id.updateindoor_price_edittext);
        updateiteam=findViewById(R.id.updateindoor_button);
        updateiteam.setOnClickListener(this);
        choose_image.setOnClickListener(this);
        databaseReference.child("IndoorPlant").child(firebaseAuth.getCurrentUser().getUid())
                .child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String data_dec=dataSnapshot.child("indoorplant_decription:").getValue().toString();
                String data_name=dataSnapshot.child("indoorplant_name").getValue().toString();
                String data_price=dataSnapshot.child("indoorplan_price").getValue().toString();
                String data_image=dataSnapshot.child("indoorplant_url").getValue().toString();
                ...
                Glide.with(UpdataIndoorplantdata.this).load(data_image).into(indoor_img);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case  R.id.updateindoor_Imagebutton_chooseimage:
                ChooseImage();
                break;
            case R.id.updateindoor_button:
                updateindoorplant();
                break;
    ...
    private void updateindoorplant() {
        ...
        databaseReference.child("Admin_User").child(firebaseAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                IndoorModel indoorModel= new IndoorModel(indoorname,description,myuri,nurrsery,indoorprice);
                databaseReference.child("IndoorPlant").child(firebaseAuth.getCurrentUser().getUid()).push().setValue(indoorModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(UpdataIndoorplantdata.this, "done", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void uploadImage() {
        ...
        reference.putFile(selectimge).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(UpdataIndoorplantdata.this, "yes", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(Userpicandotherdata.this, ""+path, Toast.LENGTH_SHORT).show();
                ...
                storageRef.child(path).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        myuri= uri.toString();
                        Toast.makeText(UpdataIndoorplantdata.this, ""+myuri, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UpdataIndoorplantdata.this, "no", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
