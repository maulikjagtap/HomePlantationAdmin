...
public class AddIndoorPlant extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_indoor_plant);
        firebaseAuth=FirebaseAuth.getInstance();
        firebaseDatabase=FirebaseDatabase.getInstance();
        databaseReference=firebaseDatabase.getReference();
        firebaseStorage=FirebaseStorage.getInstance();
        storageReference=firebaseStorage.getReference();
        indoor_img=findViewById(R.id.addindoordplant_image);
        choose_image=findViewById(R.id.addindoordplant_Imagebutton_chooseimage);
        indoor_name=findViewById(R.id.addindoordplant_name_edittext);
        indoor_decription=findViewById(R.id.addindoordplant_decription_edittext);
        indoor_price=findViewById(R.id.addindoordplant_price_edittext);
        additeam=findViewById(R.id.addindoordplant_button);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.addindoordplant_Imagebutton_chooseimage:
                ChooseImage();
                break;
            case R.id.addindoordplant_button:
                addIndoorPlant();
                break;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference.child("IndoorPlant").child(firebaseAuth.getCurrentUser().getUid()).push().setValue(indoorModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(AddIndoorPlant.this, "done", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void uploadImage() {
        ...
        reference.putFile(selectimge).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddIndoorPlant.this, "yes", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(Userpicandotherdata.this, ""+path, Toast.LENGTH_SHORT).show();
                ...
                storageRef.child(path).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        myuri= uri.toString();
                        Toast.makeText(AddIndoorPlant.this, ""+myuri, Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AddIndoorPlant.this, "no", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
